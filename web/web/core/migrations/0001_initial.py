# Generated by Django 4.0.5 on 2022-06-06 19:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=128, unique=True, verbose_name='Тема')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id_tg', models.IntegerField(blank=True, null=True, unique=True, verbose_name='Id пользователя в telegram')),
                ('birthday', models.DateField(blank=True, null=True, verbose_name='Дата рождения')),
                ('warn', models.IntegerField(default=0, verbose_name='')),
